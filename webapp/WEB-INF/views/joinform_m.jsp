	...
	<div class="pageset_m">
		...
		<div class="loginformdiv" align="center">
			<form class="form-inline" name="joinform" id="joinform"
				action="joininsert_m.do" method="post">
				<div class="form-group">
					<label for="email" class="control-label" style="width: 80%;">아이디 </label> 
					<div style="display: flex; margin-left: 10%">
						<input style="width: 70%;" type="email" class="form-control"
							name="email" id="email" placeholder="example@example.com" required>
						<input type="button" class="btn" style="width: 15%; padding: 0px;" value="중복확인" onclick="duplicationId();" />
					</div>
				</div>
				<br>
				<div class="form-group">
					<label for="nickname" class="control-label joinformlist" style="width: 80%;">닉네임</label>
					<div style="display: flex; margin-left: 10%">
						<input style="width: 70%;" type="text" class="form-control"
							name="nickname" id="nickname" placeholder="닉네임" required maxlength=6>
						<input type="button" class="btn" style="width: 15%; padding: 0px;" value="중복확인" onclick="duplicationNickname();" />
					</div>
				</div>
				<br>
				<div class="form-group" style="padding-right: 10%; padding-left: 2%;">
					<label for="password" class="control-label joinformlist" style="width: 80%;">비밀번호</label>
					<input style="width: 80%;" type="password"	class="form-control loginformlist" name="password" id="password"
