      ...
      <div class="loginformdiv" align="center">
         <form class="form-inline" name="loginform" action="login.do" method="post">
            <div class="form-group">
               ...
               <input style="width:280px;" type="email" class="form-control" id="inputEmail" placeholder="example@example.com">
            </div>
         <br>
            <div class="form-group">
               <label for="inputPassword" class="control-label loginformlist" >비밀번호:</label>
               <input style="width:280px;" type="password" class="form-control" id="inputPassword" placeholder="Password" >
            </div>
         <br>
