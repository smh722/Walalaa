...
<body>
	...
	<!-- 방 이름 / 방 만들기 / 방 나가기  --> 
	<table style="width: 900px; background-image:url('assets/images/chatBackGround.jpg');">
		<tr>
	...
	<col width="300px"> <!-- 보내기 영역 -->
		<tr height="600px;">
			...
			<td style="width: 550px" colspan="2"> 
				<div style="width: 100%; height: 550px; overflow-y:scroll; overflow-x:inherit;" class="ui message" id="output"></div>  
			</td > 
			<!-- 채팅방 목록 -->  
			   	...
			   	<div style="width:300px; height: 500px; display: none;" class="ui message" id="showCreateRoom"> 
			    	...
			    	<table style="width: 100%;height: 100%">
			      	...
			      	<tr>
			         	<th>참여인원</th>
			         	<td>
			         		<a href="#none"><img src="assets/images/arrow_back.gif" onclick="count_back()" width="13px" title="1명 감소"></a>
			           		...
			           		<a href="#none"><img src="assets/images/arrow_next.gif" onclick="count_next()" width="13px" title="1명 증가"></a>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
		   ...
		   // 그 외 회원은 admin을 제외한 다른 아이디로 접속 시, 채팅참여가 가능하다.
		      ...
		      ws = new WebSocket("ws://192.168.1.8:8181/Walalaa/echo.do");   
		   }
			...
			//처음 접속 시에만 채팅방에 추가함(현재 방정보도 같이 출력)	   
		      	...
		      	$("#buttonMessage").click(function() {
		         	...
		         	if(wisper=="" && msg !=""){
		         		//소켓으로 메세지 전달
		            	ws.send(msg+"!%/"+""+"!%/"+room);
		            	$("#output").append("<i class='user icon'></i>"+"<b style='color:blue'>[${login.email}]</b> : "+msg+"<br>");
		            	...
		            	if($("#userId").val()==wisper){
		         		...
		         		//본인이 아닐 경우에만 메세지 전달
		            		...
		            		$("#output").append("<i class='user icon'></i>"
		            	    	+"<b style='color:blue'>[${login.email}]</b> : "
