...
<body>
      ...
      <div class="loginformdiv" align="center">
         <form class="form-inline" name="joinform" id="joinform" action="joininsert.do" method="post">
            <div class="form-group">
               <label for="email" class="control-label">아이디 :</label>
               <input style="width:280px" type="email" class="form-control" name="email" id="email" placeholder="example@example.com">
               <input type="button" class="btn btn-primary" value="중복확인" onclick="duplicationId();"/>
            </div>
         <br>
            <div class="form-group">
         ...
         <br>
            ...
            <div class="form-group" align="center">   
               ...
               <button class="btn btn-primary btn-lg" onclick="DoSignUp();">회원가입</button>
            </div>   
         </form>
      </div>
   </div>
