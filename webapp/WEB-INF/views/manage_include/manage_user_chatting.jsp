...
<body>
	...
	<div class="main">
		<table class="user_chatting">
			<thead>
				<tr>
					<th colspan="2" class="col-xs-9"><img
						src="${pageContext.request.contextPath}/assets/images/user.png">시청자13
						님의 채팅 모아보기</th>
					<th class="col-xs-3"><button>채팅금지</button></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td class="col-xs-1"><input type="checkbox"></td>
					<td class="col-xs-10">ㅅㅂ 개못하는데 이런방송 왜봄?</td>
					<td class="col-xs-1">16:32:01</td>
				</tr>
				<tr>
					<td class="col-xs-1"><input type="checkbox"></td>
					<td class="col-xs-10">ㅅㅂ 개못하는데 이런방송 왜봄?</td>
			...
			<tfoot>
				<tr>
					...
					<td><input type="button" value="신고" name="btn_js_report"
						id="btn_js_report" onclick="btn_js_report_click();"></td>
					<td><input type="button" value="삭제" name="btn_js_delete"
						id="btn_js_delete" onclick="btn_js_delete_click();"></td>
				</tr>
			</tfoot>
		</table>
